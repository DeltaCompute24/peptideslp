...
export default function EbookPTLead() {
    ...
    try {
      ...
      await fetch('/api/leads/capture', {
        ...
        body: JSON.stringify({
          ...
          source: 'instagram-ebook-lead-pt',
          lang: 'pt',
        }),
      });
  ...
  return (
    <>
      <Head>
        <title>E-Book Gratuito de Protocolos Peptidicos | BioSync Peptides</title>
        <meta name="description" content="Baixe o Dicionario Completo de Protocolos Peptidicos da BioSync — 29 peptideos, 8 categorias, protocolos baseados em evidencias e guias de dosagem. PDF gratuito." />
        <meta property="og:title" content="E-Book Gratuito de Protocolos Peptidicos | BioSync Peptides" />
        <meta property="og:description" content="29 peptideos, 8 categorias, protocolos baseados em evidencias. Baixe o PDF gratuito agora." />
            ...
            {!downloaded ? (
              <>
                ...
                <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
                  ...
                  <div style={{
                    ...
                    <div style={{ fontFamily: '"Playfair Display", serif', color: '#fff', fontSize: '1.05rem', fontWeight: 700, textAlign: 'center', lineHeight: 1.3 }}>
                      Dicionario Completo de Protocolos Peptidicos
                    </div>
                    ...
                    <div style={{ color: '#8896a7', fontSize: '0.55rem', textAlign: 'center', lineHeight: 1.5 }}>
                      29 Peptideos | 8 Categorias<br />Protocolos Baseados em Evidencias
                    </div>
                  </div>
                  ...
                  <p style={{ color: '#8896a7', fontSize: '0.95rem', lineHeight: 1.7, margin: '0 0 0.5rem' }}>
                    Protocolos baseados em evidencias, guias de dosagem e dados cientificos para 29 peptideos em 8 categorias terapeuticas.
                  </p>
                </div>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.5rem', marginBottom: '1.5rem' }}>
                  {[
                    ['29 Peptideos', 'Protocolos e dosagens completos'],
                    ['8 Categorias', 'Peso, recuperacao, anti-aging...'],
                    ['100+ Estudos', 'Pesquisa baseada em evidencias'],
                    ['Guia de Dosagem', 'Reconstituicao e injecao'],
                  ].map(([title, desc]) => (
                ...
                <form onSubmit={handleSubmit} style={{
                  ...
                  <p style={{ color: '#5a6a7a', fontSize: '0.7rem', textAlign: 'center', marginTop: '0.75rem', lineHeight: 1.5 }}>
                    Enviaremos atualizacoes de protocolos e dicas via WhatsApp. Sem spam.
                  </p>
                </form>
              </>
            ) : (
              ...
              <div style={{ textAlign: 'center' }}>
                ...
                <h2 style={{ fontFamily: '"Playfair Display", serif', fontSize: '1.8rem', fontWeight: 700, color: '#fff', margin: '0 0 0.75rem' }}>
                  Seu E-Book esta Baixando!
                </h2>
                <p style={{ color: '#8896a7', fontSize: '0.95rem', lineHeight: 1.7, marginBottom: '2rem' }}>
                  Verifique sua pasta de downloads por<br />
                  <strong style={{ color: '#fff' }}>BioSync-Dicionario-Protocolos-Peptideos.pdf</strong>
                </p>
                ...
                <div style={{
                  ...
                  >
                    ...
                    <div>
                      <div style={{ color: '#fff', fontWeight: 700, fontSize: '0.95rem' }}>Receba Seu Protocolo Gratuito</div>
                      <div style={{ color: '#8896a7', fontSize: '0.8rem' }}>Protocolo personalizado com IA</div>
                    </div>
                  ...
                  >
                    ...
                    <div>
                      <div style={{ color: '#fff', fontWeight: 600, fontSize: '0.95rem' }}>Ver Catalogo de Produtos</div>
                      <div style={{ color: '#8896a7', fontSize: '0.8rem' }}>Veja todos os 17 produtos peptidicos</div>
                    </div>
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#5a6a7a" strokeWidth="2" style={{ marginLeft: 'auto', flexShrink: 0 }}><path d="M9 18l6-6-6-6"/></svg>
                  </a>
                </div>
